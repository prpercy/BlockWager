...
if st.session_state.user_account_addr and st.session_state.isRegistered:
    ...
    (st.session_state.user_balance_wallet_ether, st.session_state.user_balance_wallet_token) = (w3.eth.getBalance(st.session_state.user_account_addr), contract.functions.balanceCbetTokens(st.session_state.user_account_addr).call())
    ...
    if (st.session_state.is_first_time):
        ...
        if (                                  (st.session_state.user_balance_wallet_ether_pre != st.session_state.user_balance_wallet_ether) and                                                        (st.session_state.user_balance_wallet_token_pre == st.session_state.user_balance_wallet_token)):
            st.write("User Wallet Balance ==> ETH:" + str(st.session_state.user_balance_wallet_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_wallet_ether/WEI_FACTOR)         + " / CBET:" + str(st.session_state.user_balance_wallet_token/WEI_FACTOR))
        elif (                                (st.session_state.user_balance_wallet_ether_pre == st.session_state.user_balance_wallet_ether) and                                                         (st.session_state.user_balance_wallet_token_pre != st.session_state.user_balance_wallet_token)):
            st.write("User Wallet Balance ==> ETH:" + str(st.session_state.user_balance_wallet_ether/WEI_FACTOR)                                                                                   + " / CBET:" + str(st.session_state.user_balance_wallet_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_wallet_token/WEI_FACTOR))
        elif (                                (st.session_state.user_balance_wallet_ether_pre != st.session_state.user_balance_wallet_ether) and                                                         (st.session_state.user_balance_wallet_token_pre != st.session_state.user_balance_wallet_token)):
            st.write("User Wallet Balance ==> ETH:" + str(st.session_state.user_balance_wallet_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_wallet_ether/WEI_FACTOR)         + " / CBET:" + str(st.session_state.user_balance_wallet_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.user_balance_wallet_token/WEI_FACTOR))
        else :
             st.write("User Wallet Balance ==> ETH:" + str(st.session_state.user_balance_wallet_ether/WEI_FACTOR)                                                                                  + " / CBET:" + str(st.session_state.user_balance_wallet_token/WEI_FACTOR))

        if (                                         (st.session_state.user_balance_betting_ether_pre != st.session_state.user_balance_betting_ether) and                                                 (st.session_state.user_balance_betting_token_pre == st.session_state.user_balance_betting_token)):
            st.write("BlockWager Betting Balance ==> ETH:" + str(st.session_state.user_balance_betting_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_betting_ether/WEI_FACTOR) + " / CBET:" + str(st.session_state.user_balance_betting_token/WEI_FACTOR))
        elif (                                       (st.session_state.user_balance_betting_ether_pre == st.session_state.user_balance_betting_ether) and                                                 (st.session_state.user_balance_betting_token_pre != st.session_state.user_balance_betting_token)):
            st.write("BlockWager Betting Balance ==> ETH:" + str(st.session_state.user_balance_betting_ether/WEI_FACTOR)                                                                            + " / CBET:" + str(st.session_state.user_balance_betting_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_betting_token/WEI_FACTOR))
        elif (                                       (st.session_state.user_balance_betting_ether_pre != st.session_state.user_balance_betting_ether) and                                                 (st.session_state.user_balance_betting_token_pre != st.session_state.user_balance_betting_token)):
            st.write("BlockWager Betting Balance ==> ETH:" + str(st.session_state.user_balance_betting_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_betting_ether/WEI_FACTOR) + " / CBET:" + str(st.session_state.user_balance_betting_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.user_balance_betting_token/WEI_FACTOR))
        else:
            st.write("BlockWager Betting Balance ==> ETH:" + str(st.session_state.user_balance_betting_ether/WEI_FACTOR)                                                                            + " / CBET:" + str(st.session_state.user_balance_betting_token/WEI_FACTOR))

        if (                                        (st.session_state.user_balance_escrow_ether_pre != st.session_state.user_balance_escrow_ether) and                                                    (st.session_state.user_balance_escrow_token_pre == st.session_state.user_balance_escrow_token)):
            st.write("BlockWager Escrow Balance ==> ETH:" + str(st.session_state.user_balance_escrow_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_escrow_ether/WEI_FACTOR)    + " / CBET:" + str(st.session_state.user_balance_escrow_token/WEI_FACTOR))
        elif (                                      (st.session_state.user_balance_escrow_ether_pre == st.session_state.user_balance_escrow_ether) and                                                    (st.session_state.user_balance_escrow_token_pre != st.session_state.user_balance_escrow_token)):
            st.write("BlockWager Escrow Balance ==> ETH:" + str(st.session_state.user_balance_escrow_ether/WEI_FACTOR)                                                                              + " / CBET:" + str(st.session_state.user_balance_escrow_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_escrow_token/WEI_FACTOR))
        elif (                                      (st.session_state.user_balance_escrow_ether_pre != st.session_state.user_balance_escrow_ether) and                                                    (st.session_state.user_balance_escrow_token_pre != st.session_state.user_balance_escrow_token)):
            st.write("BlockWager Escrow Balance ==> ETH:" + str(st.session_state.user_balance_escrow_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.user_balance_escrow_ether/WEI_FACTOR)    + " / CBET:" + str(st.session_state.user_balance_escrow_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.user_balance_escrow_token/WEI_FACTOR))
        else:
            st.write("BlockWager Escrow Balance ==> ETH:" + str(st.session_state.user_balance_escrow_ether/WEI_FACTOR)                                                                              + " / CBET:" + str(st.session_state.user_balance_escrow_token/WEI_FACTOR))
    ...
    if (st.session_state.is_first_time):
       ...
       st.write("House Escrow Balance ==> ETH:" + str(st.session_state.house_balance_escrow_ether/WEI_FACTOR)   + " / CBET:" + str(st.session_state.house_balance_escrow_token/WEI_FACTOR))
        ...
        if (                                     (st.session_state.balance_owner_ether_pre != st.session_state.balance_owner_ether) and                                                                (st.session_state.balance_owner_token_pre == st.session_state.balance_owner_token)):
            st.write("Owner/Deployer Balance ==> ETH:" + str(st.session_state.balance_owner_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.balance_owner_ether/WEI_FACTOR)                + " / CBET:" + str(st.session_state.balance_owner_token/WEI_FACTOR))
        elif (                                   (st.session_state.balance_owner_ether_pre == st.session_state.balance_owner_ether) and                                                                (st.session_state.balance_owner_token_pre != st.session_state.balance_owner_token)):
            st.write("Owner/Deployer Balance ==> ETH:" + str(st.session_state.balance_owner_ether/WEI_FACTOR)                                                                                    + " / CBET:" + str(st.session_state.balance_owner_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.balance_owner_token/WEI_FACTOR))
        elif (                                   (st.session_state.balance_owner_ether_pre != st.session_state.balance_owner_ether) and                                                                (st.session_state.balance_owner_token_pre != st.session_state.balance_owner_token)):
            st.write("Owner/Deployer Balance ==> ETH:" + str(st.session_state.balance_owner_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.balance_owner_ether/WEI_FACTOR)                + " / CBET:" + str(st.session_state.balance_owner_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.balance_owner_token/WEI_FACTOR))
        else :
             st.write("Owner/Deployer Balance ==> ETH:" + str(st.session_state.balance_owner_ether/WEI_FACTOR)                                                                                   + " / CBET:" + str(st.session_state.balance_owner_token/WEI_FACTOR))
      
        if (                                    (st.session_state.house_balance_betting_ether_pre != st.session_state.house_balance_betting_ether) and                                                 (st.session_state.house_balance_betting_token_pre == st.session_state.house_balance_betting_token)):
            st.write("House Betting Balance ==> ETH:" + str(st.session_state.house_balance_betting_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_betting_ether/WEI_FACTOR) + " / CBET:" + str(st.session_state.house_balance_betting_token/WEI_FACTOR))
        elif (                                  (st.session_state.house_balance_betting_ether_pre == st.session_state.house_balance_betting_ether) and                                                 (st.session_state.house_balance_betting_token_pre != st.session_state.house_balance_betting_token)):
            st.write("House Betting Balance ==> ETH:" + str(st.session_state.house_balance_betting_ether/WEI_FACTOR)                                                                             + " / CBET:" + str(st.session_state.house_balance_betting_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_betting_token/WEI_FACTOR))
        elif (                                  (st.session_state.house_balance_betting_ether_pre != st.session_state.house_balance_betting_ether) and                                                 (st.session_state.house_balance_betting_token_pre != st.session_state.house_balance_betting_token)):
            st.write("House Betting Balance ==> ETH:" + str(st.session_state.house_balance_betting_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_betting_ether/WEI_FACTOR) + " / CBET:" + str(st.session_state.house_balance_betting_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.house_balance_betting_token/WEI_FACTOR))
        else :
             st.write("House Betting Balance ==> ETH:" + str(st.session_state.house_balance_betting_ether/WEI_FACTOR)                                                                            + " / CBET:" + str(st.session_state.house_balance_betting_token/WEI_FACTOR))

        if (                                   (st.session_state.house_balance_escrow_ether_pre != st.session_state.house_balance_escrow_ether) and                                                    (st.session_state.house_balance_escrow_token_pre == st.session_state.house_balance_escrow_token)):
            st.write("House Escrow Balance ==> ETH:" + str(st.session_state.house_balance_escrow_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_escrow_ether/WEI_FACTOR)    + " / CBET:" + str(st.session_state.house_balance_escrow_token/WEI_FACTOR))
        elif (                                 (st.session_state.house_balance_escrow_ether_pre == st.session_state.house_balance_escrow_ether) and                                                    (st.session_state.house_balance_escrow_token_pre != st.session_state.house_balance_escrow_token)):
            st.write("House Escrow Balance ==> ETH:" + str(st.session_state.house_balance_escrow_ether/WEI_FACTOR)                                                                               + " / CBET:" + str(st.session_state.house_balance_escrow_token_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_escrow_token/WEI_FACTOR))
        elif (                                 (st.session_state.house_balance_escrow_ether_pre != st.session_state.house_balance_escrow_ether) and                                                    (st.session_state.house_balance_escrow_token_pre != st.session_state.house_balance_escrow_token)):
            st.write("House Escrow Balance ==> ETH:" + str(st.session_state.house_balance_escrow_ether_pre/WEI_FACTOR)  + "-->" + str(st.session_state.house_balance_escrow_ether/WEI_FACTOR)    + " / CBET:" + str(st.session_state.house_balance_escrow_token_pre/WEI_FACTOR) + "-->" + str(st.session_state.house_balance_escrow_token/WEI_FACTOR))
        else :
             st.write("House Escrow Balance ==> ETH:" + str(st.session_state.house_balance_escrow_ether/WEI_FACTOR)                                                                              + " / CBET:" + str(st.session_state.house_balance_escrow_token/WEI_FACTOR))
