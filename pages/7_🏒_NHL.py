...
# Layout
st.set_page_config(page_title='NHL Odds and Bets', page_icon=':bar_chart:', layout='wide')
st.title('🏒 NHL Odds and Bets')
...
def getOdds(sportsbook):
    odds = None
    if sportsbooks != None:
        dict_games = SbrOddsProvider(sportsbook, "NHL").get_odds()
    else:
